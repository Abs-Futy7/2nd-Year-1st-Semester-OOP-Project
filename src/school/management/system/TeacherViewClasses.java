...
public class TeacherViewClasses extends JFrame {
    ...
    private List<ClassAssignment> fetchAssignments(Connection connection, String teacherId) throws SQLException {
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new TeacherViewClasses());
    }
}